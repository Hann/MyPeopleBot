...
var result = function(data) {
  ...
  try {
      table = html.find('//*[@id="formBugReport"]/table[1]')[0].parent();
  }
  catch (err) {
    table = null;
  }
...
exports.sendTo = function(message, callback) {
  ...
  var options = {
    hostname: '164.125.36.75',
    headers: {
      'Content-Type': 'application/x-www-form-urlencoded',
      'Content-Length': formData.length
    },
    port: 80,
    path: '/PnuSpellerISAPI_201107/lib/PnuSpellerISAPI_201107.dll?Check',
    method: 'POST'
  };
